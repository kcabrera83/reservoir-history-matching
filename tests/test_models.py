...
def test_models():
    results = {}
    results['oil_production'] = evaluate_model(os.path.join(MODEL_DIR, 'oil_production_model.pkl'), X, y)
    results['gas_production'] = evaluate_model(os.path.join(MODEL_DIR, 'gas_production_model.pkl'), X, y)
    return results
